     ...
     <div class="top-row">
		...
		<form action="" method="post">
            ...
            <div class="field-wrap">
                <input type="text"required autocomplete="off" placeholder="Email Address" class="textbox" name="txt_email"/>
          </div>
          
          <div class="field-wrap">
              <input type="password"required autocomplete="off" placeholder="Password" class="textbox" name="txt_password"/>
          </div>
           <br>   
           <button type="submit" class="button" name="btn_login"/>login</button>
